...
class ModalLokasi extends HTMLElement {
    constructor() {
        ...
        <div
            ...
            <form action="./belumtersedia.html" class="pt-4 px-2">
    ...
    constructor() {
        ...
        <div class="2xl:container 2xl:mx-auto py-10 px-4 sm:px-10 md:px-28 flex justify-center items-center">
                <div
                    ...
                    <div
                        class="bg-body-white w-fit max-w-3xl h-[450px] text-primary-hover overflow-auto touch-pan-x touch-pan-y scrollbar-thin scrollbar-thumb-primary-hover scrollbar-track-emerald-600 transition-all">
                    ...
                    <div class="text-center my-2 relative h-9 w-full">
                        <button onclick="showFAQ(true)" class="absolute left-auto bottom-0 right-4 w-min py-2 px-4 rounded-md text-sm font-medium hover:bg-gray-100 text-primary-hover bg-body-white transition">Tutup</button>
                    </div> 
                </div>
            </div>
        `
